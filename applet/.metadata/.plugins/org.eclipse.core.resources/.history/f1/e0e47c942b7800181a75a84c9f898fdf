 ...
 */
	...
	public final short init4load(short num, byte[] data){
		...
		keyID = pTemp32[3]; //密钥版本
		algID = pTemp32[4]; //算法标识
		Util.arrayCopyNonAtomic(pTemp32, (short)5, pTemp16, (short)0, length); //密钥值储存在pTemp16中
		
		
		//伪随机数(4)||电子钱包联机交易序号(2)||8000
		//产生随机数
		...
		EnCipher.gen_processkey(pTemp16, pTemp32, (short)0, (short)8, pTemp82, (short)0);//过程密钥储存在pTemp82中
		
		//产生MAC1
		//电子钱包余额(4)||交易金额(4)||交易类型标识(0x02)||终端机编号
		...
		EnCipher.gen_mac(pTemp82, pTemp32, (short)0x0F, pTemp41);
	...
	public final short load(byte[] data){
		...
		EnCipher.gen_mac(pTemp82, pTemp32, (short)0x12, pTemp41);
		...
		//TAC的计算
		short length, num;
		num = keyfile.findKeyByType((byte)0x34); //0x34 TAC密钥类型
		...
		EnCipher.xor(pTemp82, pTemp16, (short)13);
		EnCipher.gen_mac(pTemp82, pTemp32, (short)0x18, data);
	...
	public final short purchase(byte[] data){
		...
		//产生过程密钥 伪随机数||电子钱包脱机交易序号||终端交易序号的最右两个字节
		...
		EnCipher.gen_processkey(pTemp16, pTemp32, (short)0, (short)8, pTemp82, (short)0); 
		//产生MAC1 交易金额||交易类型标识(0x06)||终端机编号||交易日期（主机）||交易时间（主机）
		Util.arrayCopyNonAtomic(pTemp42, (short)0, pTemp32, (short)0, (short)4);       //交易金额
		...
		//产生MAC2
		Util.arrayCopyNonAtomic(pTemp42, (short)0, pTemp32, (short)0, (short)4);       //交易金额
		EnCipher.gen_mac(pTemp82, pTemp32, (short)0x04, pTemp41);
		...
		Util.arrayCopyNonAtomic(pTemp16, (short)5, pTemp82, (short)0, (short)8);
		EnCipher.xor(pTemp82, pTemp16, (short)13);
		EnCipher.gen_mac(pTemp82, pTemp32, (short)0x16, data);
